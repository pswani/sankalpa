...
public final class SankalpaApplicationService {
    ...
    public func declareSankalpa(
        ...
        do { try sankalpas.save(sankalpa) } catch { throw .storage(error) }
        return sankalpa
    }
    ...
    public func logSession(
        ...
        do { try sessions.save(session) } catch { throw .storage(error) }
        return session
    }
    ...
    public func undoLoggedSession(_ sessionId: SessionId) throws(SankalpaCommandError) {
        do { try sessions.delete(sessionId) } catch { throw .storage(error) }
    }
